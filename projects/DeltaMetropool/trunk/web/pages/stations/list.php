...
?>
						<tr>
							<td><a href="admin.php?view=stations&action=edit" class="button">Nieuw Station</a></td>
						</tr>
						<tr>
							<td>
								<table class="data">
...
<?php
	foreach ($stations as $station_key => $station_value) 
	{
		echo "\t\t\t\t\t\t\t\t\t" . '<tr class="' . $class . '">' . "\n";
		echo "\t\t\t\t\t\t\t\t\t\t" . '<td>' . "\n";
		echo "\t\t\t\t\t\t\t\t\t\t\t" . '<a href="admin.php?view=stations&action=edit&station=' . $station_value->id . '" class="button">Edit</a>' . "\n";
		echo "\t\t\t\t\t\t\t\t\t\t" . '</td>' . "\n";
