package SprintStad.State 
{
	...
	public class ValuesState implements IState
	{
		...
		private function drawUI()
		{
			...
			TextArea(parent.values_movie.description_field).text = parent.GetValues().description;
		...
		private function uploadXML():void 
		{
			...
			var request:URLRequest= new URLRequest(SprintStad.DOMAIN + "data/values.php?session=" + parent.session);
			request.contentType = "text/xml";
			request.data = parent.GetValues().GetXmlString();
		...
		public function Activate():void
		{
			...
			var urlLoader:URLLoader = new URLLoader(new URLRequest(SprintStad.DOMAIN + "data/values.php"));
