		...
		<div class="area">
			...
			<table border="2">
				<tr>
					...
					<th class="first-column">Team name</th>
					<th>Ambitions</th>
					<th>Ambition description</th>
					<th>Stations</th>
				</tr>
<?php
...
?>					
			...
			?>
				...
				<tr><td class="first-column">Initieel</td>
					...
					?>
				<tr><td class="first-column">Master plan</td>
					<?php
				...
				<tr><td class="first-column">Current simple</td>
					<?php
					...
					?>
				<tr><td class="first-column">Current complete</td>
					<?php
